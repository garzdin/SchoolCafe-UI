          ...
          <div className="row">
                ...
                <div className="box-body">
                  <ul className="todo-list">
                    <li>
                      ...
                      <input type="checkbox" value="" onChange={() => null} />
              ...
              <div className="box box-info">
                ...
                <div className="box-body">
                  <form action="#" method="post">
                    ...
                    <div>
                      <textarea className="textarea" placeholder="Message" style={{flex: 1, height: 125, fontSize: 14, lineHeight: 18, borderWidth: 1, borderColor: '#dddddd', padding: 10}}></textarea>
                    </div>
                  </form>
                </div>
            ...
            <section className="col-lg-5 connectedSortable">
              ...
              <div className="box box-solid bg-light-blue-gradient">
                ...
                <div className="box-body">
                  <div id="world-map" style={{height: 250, flex: 1}}></div>
                </div>

                <div className="box-footer no-border">
                  <div className="row">
                    <div className="col-xs-4 text-center" style={{borderRightWidth: 1, borderColor: '#f4f4f4'}}>
              ...
              <div className="box box-solid bg-teal-gradient">
                ...
                <div className="box-footer no-border">
                  <div className="row">
                    <div className="col-xs-4 text-center" style={{borderRightWidth: 1, borderColor: '#f4f4f4'}}>
                      <input type="text" className="knob" data-readonly="true" value="20" readOnly={true} data-width="60" data-height="60" data-fgColor="#39CCCC" />

                      <div className="knob-label">Mail-Orders</div>
                    </div>

                    <div className="col-xs-4 text-center" style={{borderRightWidth: 1, borderColor: '#f4f4f4'}}>
                      <input type="text" className="knob" data-readonly="true" value="50" readOnly={true} data-width="60" data-height="60" data-fgColor="#39CCCC" />

                      <div className="knob-label">Online</div>
                    </div>

                    <div className="col-xs-4 text-center">
                      <input type="text" className="knob" data-readonly="true" value="30" readOnly={true} data-width="60" data-height="60" data-fgColor="#39CCCC" />
                  ...
                  <div className="row">
                    <div className="col-sm-6">
                      ...
                      <div className="progress xs">
                        <div className="progress-bar progress-bar-green" style={{flex: 0.9}}></div>
                      </div>
                      ...
                      <div className="progress xs">
                        <div className="progress-bar progress-bar-green" style={{flex: 0.7}}></div>
                      </div>
                    </div>
                    ...
                    <div className="col-sm-6">
                      ...
                      <div className="progress xs">
                        <div className="progress-bar progress-bar-green" style={{flex: 0.6}}></div>
                      </div>
                      ...
                      <div className="progress xs">
                        <div className="progress-bar progress-bar-green" style={{flex: 0.4}}></div>
                      </div>
                    </div>
